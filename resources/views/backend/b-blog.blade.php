    ...
    <div class="card">
        <div class="card-body">
            ...
            <form>
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">Ana Başlık1</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">Ana Başlık2</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">Yazar</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">Yorum Sayısı</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control">
                    </div>
                </div>
